    ...
    formValidationSchema
      ...
      .then((validatedData) => {
        ...
        if (id === 'new') {
          ...
          UsersService.updateById(id, { id: id, ...validatedData }).then((result) => {
            setIsLoading(false);
          ...
          <Grid container direction="column" padding={2} spacing={2}>
            ...
            <Grid container item direction="row" spacing={2}>
              <Grid item xs={12} sm={12} md={6} lg={4} xl={2}>
                <VTextField fullWidth name="name" disabled={isLoading} label="Name" onChange={(e) => setName(e.target.value)} />
              </Grid>
            </Grid>
            ...
            <Grid container item direction="row" spacing={2}>
              <Grid item xs={12} sm={12} md={6} lg={4} xl={2}>
                <VTextPasswordField fullWidth name="password" label="Password" disabled={isLoading} />
              </Grid>
            </Grid>

            <Grid container item direction="row" spacing={2}>
              <Grid item xs={12} sm={12} md={6} lg={4} xl={2}>
                <VTextPhoneField fullWidth name="phone" label="Phone" disabled={isLoading} />
              </Grid>
            </Grid>
          </Grid>
        </Box>
